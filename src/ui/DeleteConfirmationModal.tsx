...
// Shared confirmation dialog for destructive admin actions. Accessible: uses an
// alertdialog role with focus trap, Escape-to-close, and focus restore so it
// replaces the native, screen-reader-unfriendly window.confirm().
        ...
        >
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                <p id={descriptionId} className="text-sm text-gray-500">{message}</p>
              </div>
            </div>
          </div>
